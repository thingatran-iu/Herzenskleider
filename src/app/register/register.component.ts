...
export class RegisterComponent {
  ...
  */
  ...
  /**
   * Prüft, ob die Postleitzahl gültig ist.
   */
  ...
  /**
   * Erfolgreiche Registrierung: Daten speichern und zur Bestätigung navigieren.
   */
  ...
  /**
   * Blättert zur vorherigen Seite in der Formular-Navigation.
   */
  onPrevious(): void {
    if (this.currentPage > 1) this.currentPage--;
  }
  /**
   * Blättert zur nächsten Seite in der Formular-Navigation.
   */
  onNext(): void {
    if (this.currentPage === 1) this.currentPage++;
  }
